...
const (
	...
	DeviceAgent_ListUiElements_FullMethodName         = "/agent.DeviceAgent/ListUiElements"
...
type DeviceAgentClient interface {
	...
	ListUiElements(ctx context.Context, in *ListUiElementsRequest, opts ...grpc.CallOption) (*ListUiElementsResponse, error)
...
func (c *deviceAgentClient) ListUiElements(ctx context.Context, in *ListUiElementsRequest, opts ...grpc.CallOption) (*ListUiElementsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListUiElementsResponse)
	err := c.cc.Invoke(ctx, DeviceAgent_ListUiElements_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceAgentServer interface {
	...
	ListUiElements(context.Context, *ListUiElementsRequest) (*ListUiElementsResponse, error)
	// APK management (번들 폴더 list, install, uninstall)
...
func (UnimplementedDeviceAgentServer) ListUiElements(context.Context, *ListUiElementsRequest) (*ListUiElementsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListUiElements not implemented")
}
...
func _DeviceAgent_ListUiElements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListUiElementsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceAgentServer).ListUiElements(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceAgent_ListUiElements_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceAgentServer).ListUiElements(ctx, req.(*ListUiElementsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeviceAgent_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListUiElements",
			Handler:    _DeviceAgent_ListUiElements_Handler,
		},
		{
