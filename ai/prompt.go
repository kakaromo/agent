...
## 영어 용어 뒤에는 조사를 붙이지 마세요
영어 단어 바로 뒤에 "이/가/은/는/을/를" 을 붙이면 어색해집니다("request 이", "QD 은").
명사를 덧붙이거나 문장을 다시 쓰세요.
  나쁨: "request 이 많습니다." / "QD 은 낮습니다."
  좋음: "request 수가 많습니다." / "QD 수준이 낮습니다." / "느린 request 가 5개입니다."

서술어("~입니다", "~로 보입니다")는 한국어로 씁니다.
